...
# frm3 = tk.Frame(master=window, width=50, height=50)
# frm3.pack(side=tk.TOP)
#
# frm2 = tk.Frame(master=window, width=50, height=50)
# frm2.pack(side=tk.TOP)
#
#
# frm1 = tk.Frame(master=window, width=50, height=50)
# frm1.pack(side=tk.TOP)
#
#
# frm4 = tk.Frame(master=window, width=50, height=50)
# frm4.pack(side=tk.TOP)
#
#
# frm5 = tk.Frame(master=window, width=50, height=50)
# frm5.pack(side=tk.TOP)
#
#
# frm6 = tk.Frame(master=window, width=50, height=50)
# frm6.pack(side=tk.BOTTOM)
#
# btn9 = tk.Button(
#     text= "9",
#     width = 3,
